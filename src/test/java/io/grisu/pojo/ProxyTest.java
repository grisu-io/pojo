...
public class ProxyTest {
    ...
    @Test
    public void shouldTestCGLibProxy() {
        final MyTestingClass myTestingClass = AbstractPojo.instance(MyTestingClass.class);

        myTestingClass.setValueColumn(null);
        myTestingClass.setValueColumn("yoo");
    }
